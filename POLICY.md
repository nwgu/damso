...
| 집지키기 | `com.damso.homekeep` | **광고 + 통계** | 게임 기록은 기기 내 저장만. **AdMob 보상형 광고**(오두막이 무너진 뒤 이어하기, 판당 1회) · **Google 애널리틱스** (2026-08-28) |
...
⚠ **하루 만에 이 문장을 한 번 고쳤다** (8/28 저녁, 시행 8/29). 처음 적을 때는
집지키기가 `ads.gd` 를 아무 데서도 안 불러서 *"광고 SDK 가 포함되어 있으며,
초기화되는 과정에서"* 라고 약하게 적었는데, **같은 날 부활 광고를 붙이면서
철이 지났다.** 지금은 두 게임과 같은 *"보상형 광고를 제공하며"* 다.

> **기능을 붙이는 날에 방침을 먼저 적지 말 것.** 코드가 확정된 뒤에 적어야
> 하루 만에 두 번 고치지 않는다.
