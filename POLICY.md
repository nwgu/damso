...
| 문서 | 시행일자 |
|---|---|
| 개인정보처리방침 | **2026년 8월 31일 / August 31, 2026** (7일 유예 적용) |
...
### 키네틱코어에 애널리틱스가 들어갔다 (2026-08-24, 시행 2026-08-31)
...
**시행일자를 8월 31일로 잡은 이유** — 방침 7항이 "변경사항 시행 7일 전부터 공지" 를
약속하고 있고, 이용 목적 추가는 거기 해당한다고 봤다. 애널리틱스가 들어간 **1.0.3 은
그 날짜 이후에 출시**한다. 1.0.2 까지는 애널리틱스가 없으므로 유예 중에도 어긋남이 없다.
