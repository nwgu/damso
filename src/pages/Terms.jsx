            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="prose max-w-none space-y-6 text-gray-700">
                    <section>
                        ...
                        <p>본 약관은 담소(이하 "회사")가 제공하는 모든 서비스(이하 "서비스")의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 mt-2">
                            <li>회사가 개발하여 제공하는 각종 모바일 애플리케이션 서비스</li>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-3">제8조 (저작권의 귀속 및 이용제한)</h2>
                        <p>회사가 작성한 저작물에 대한 저작권 기타 지적재산권은 회사에 귀속합니다.</p>
                        <p className="mt-2">회원은 서비스를 이용함으로써 얻은 정보 중 회사에게 지적재산권이 귀속된 정보를 회사의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-2">회사는 회원의 귀책사유로 인한 서비스 이용의 장애에 대하여 책임을 지지 않습니다.</p>
                    </section>
